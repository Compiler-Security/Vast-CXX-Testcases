...
cmake .. \
    ...
    -DNEO4J_USER=${NEO4J_USER} -DNEO4J_PASSWORD=${NEO4J_PASSWORD} -DNEO4J_ADDRESS=${NEO4J_ADDRESS} \
    -DNEO4J_DATABASE=${NEO4J_DATABASE} -DNEO4J_UID_ALLOC_SIZE=${NEO4J_UID_ALLOC_SIZE} \
    &> /dev/null
